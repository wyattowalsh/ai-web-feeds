...
This document maps requirements to implementation tasks and test cases, ensuring
complete coverage and enabling impact analysis for changes.
...
- E2E: `test_save_dashboard.spec.ts` - User saves dashboard, reloads page, sees saved
  state
...
- E2E: `test_dashboard_recovery.spec.ts` - User refreshes during edit, auto-save
  restores work
...
- **Affected Tests**: test_device_id.py, test_device_switching.spec.ts,
  test_dashboard_crud.spec.ts
