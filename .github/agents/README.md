...
Use this agent when reviewing or normalizing feed submission issues. It is scoped
to repository data quality and maintainer triage, not repository mutation.

### `feed-discovery-scout`

Use this agent when preparing a weekly or manual discovery report. It is scoped to
gap analysis, candidate lead triage, and safe handoff for maintainer review.
