...
<Callout type="info">Entry point: [Contributing overview](/docs/development/contributing)</Callout>
...
Ruff, ty, Pytest, and Coverage are configured in `pyproject.toml` and the local
pre-commit hook:
