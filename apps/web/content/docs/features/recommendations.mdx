...
- feed actions for opening a result in `/feeds?mode=catalog`, subscribing, or dismissing it
...
That unavailable state is expected behavior in backend-free local development and should not compete with the main reading path.
