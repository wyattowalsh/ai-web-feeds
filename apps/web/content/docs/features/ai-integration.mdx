...
<Cards>
  <Card icon={<Search />}>**Discovery** `/llms.txt` endpoint lists all available docs</Card>
  <Card icon={<FileText />}>**Full Docs** `/llms-full.txt` provides complete documentation</Card>
  <Card icon={<Code />}>**Markdown** `.mdx` and `.md` extensions for any page</Card>
  <Card icon={<Sparkles />}>**Smart Routing** Automatic content negotiation</Card>
</Cards>
