...
description: Current section-aware llms-full.txt structure, page metadata fields, and parsing expectations for the live docs corpus
icon: FileCode
---
...
- **Section-aware table of contents** for navigation
...
Table of Contents:
  ...
  [Features]
    3. PDF Export - /docs/features/pdf-export
    4. AI & LLM Integration - /docs/features/ai-integration

  [Guides]
    5. Getting Started - /docs/guides/getting-started
    6. Quick Reference - /docs/guides/quick-reference
...
URL: https://yourdomain.com/docs/guides/getting-started
MARKDOWN: https://yourdomain.com/docs/guides/getting-started.mdx
...
MARKDOWN: /docs/guides/getting-started.mdx
SECTION: Guides
SUMMARY: Install ai-web-feeds, initialize the local data workflow, and launch the docs app with the repository-approved toolchain.
...
| `URL`         | Full page URL               | `https://yourdomain.com/docs/guides/getting-started`     |
| `MARKDOWN`    | Canonical markdown endpoint | `https://yourdomain.com/docs/guides/getting-started.mdx` |
| `DESCRIPTION` | Frontmatter summary         | `Install ai-web-feeds...`                                |
| `SECTION`     | Navigation section title    | `Guides`                                                 |
| `SECTION_KEY` | Section slug key            | `guides`                                                 |
| `PATH`        | Public docs path            | `/docs/guides/getting-started`                           |
...
- **Per-page metadata** - Title, URL, description, section, and path

### Multiple Access Patterns

- **Complete documentation** - Single request for all content
- **Section-aware table of contents** - Quick overview of structure
- **Individual pages** - URLs for targeted access
- **Markdown endpoints** - Source content links
- **Duplicate-title disambiguation** - Section metadata distinguishes similarly named pages
...
- [Docs Maintenance Checklist](/docs/contributing/docs-maintenance) - Route and metadata checks after docs changes
