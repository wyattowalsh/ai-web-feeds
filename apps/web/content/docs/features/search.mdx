...
description: Reader article browse plus source discovery through /reader, /sources, source pages, topic pages, and article references
---
...
- `/articles/[articleId]` exposes article attribution pages when a corpus exists
