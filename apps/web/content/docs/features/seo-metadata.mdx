...
```bash
curl https://aiwebfeeds.vercel.app/sitemap.xml
```
...
Sitemap: https://aiwebfeeds.vercel.app/sitemap.xml
```
...
```bash
# View page source
curl https://aiwebfeeds.vercel.app/docs | grep -i "og:"
curl https://aiwebfeeds.vercel.app/docs | grep -i "twitter:"
```
...
```bash
curl https://aiwebfeeds.vercel.app/docs | head -100
```
...
```bash
curl https://aiwebfeeds.vercel.app/robots.txt
```
