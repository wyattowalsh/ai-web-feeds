...
```bash
curl https://aiwebfeeds.w4w.dev/sitemap.xml
```
...
Sitemap: https://aiwebfeeds.w4w.dev/sitemap.xml
```
...
```bash
# View page source
curl https://aiwebfeeds.w4w.dev/docs | grep -i "og:"
curl https://aiwebfeeds.w4w.dev/docs | grep -i "twitter:"
```
...
```bash
curl https://aiwebfeeds.w4w.dev/docs | head -100
```
...
```bash
curl https://aiwebfeeds.w4w.dev/robots.txt
```
