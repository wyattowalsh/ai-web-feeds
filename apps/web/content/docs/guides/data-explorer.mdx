---
title: Data Explorer
description: Legacy taxonomy map reference; the public explorer route has been removed.
---

# Data Explorer

The former Data Explorer at `/explorer` has been removed from the public UI.
Use `/` for the reader, `/?mode=catalog` for source refinement, and repo data
