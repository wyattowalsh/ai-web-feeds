---
title: Data Explorer
description: Browse the live feed catalog in table or graph form, switch between topics, feeds, and the combined network, and keep state in the URL
---
...
The Data Explorer is the live catalog surface at [/explorer](/explorer). It lets you inspect topics and feeds as searchable tables or as interactive graphs, with the current state persisted into the URL so you can share the exact view you are using.
