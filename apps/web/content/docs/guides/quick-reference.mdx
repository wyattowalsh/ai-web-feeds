...
<Callout type="info">`/llms-full.txt` has enhanced structure with metadata, TOC, and clear separators. See [Format Documentation](/docs/features/llms-full-format).</Callout>
