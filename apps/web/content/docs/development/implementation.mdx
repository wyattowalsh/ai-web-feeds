...
<Accordions>
  ...
  <Accordion title="5. Content Statistics">
    Analyze content coverage and topics:
...
<Callout type="info">The v3 contract is applied through reviewed Alembic migrations; JSON columns remain only where the public model needs structured metadata.</Callout>
