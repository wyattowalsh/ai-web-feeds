...
<Tabs items={['uv Scripts (Recommended)', 'CLI Direct', 'Script Wrapper']}>
  ...
  <Tab value="CLI Direct">
    ...
    # Run with coverage
    uv run ai-web-feeds test coverage --open

    # E2E tests only
    uv run ai-web-feeds test e2e

    # Get help
    uv run ai-web-feeds test --help
    ```
...
<Tabs items={['Development', 'CI/CD', 'Debugging']}>
  ...
  <Tab value="Debugging">
    ...
    uv run ai-web-feeds test file test_models.py -k "twitter"

    # Show local variables
    uv run ai-web-feeds test all --verbose
    ```
...
test = "ai-web-feeds test all"
test-all = "ai-web-feeds test all"
test-unit = "ai-web-feeds test unit"
test-unit-fast = "ai-web-feeds test unit --fast"
test-integration = "ai-web-feeds test integration"
test-e2e = "ai-web-feeds test e2e"
test-coverage = "ai-web-feeds test coverage"
test-coverage-open = "ai-web-feeds test coverage --open"
test-quick = "ai-web-feeds test quick"
test-debug = "ai-web-feeds test debug"
test-watch = "ai-web-feeds test watch"
test-markers = "ai-web-feeds test markers"
```
...
uv run ai-web-feeds test all --verbose --coverage
uv run ai-web-feeds test unit --fast
uv run ai-web-feeds test debug packages/ai_web_feeds/unit/test_models.py
