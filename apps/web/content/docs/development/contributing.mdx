...
<Cards>
    <Card
        ...
        href="/docs/contributing/development-workflow"
        description="Environment setup, branch strategy, testing flow, and day-to-day development commands."
    />
    <Card
        title="Pre-commit Hooks"
        href="/docs/contributing/pre-commit-hooks"
        description="Hook installation, local troubleshooting, and how the same checks run in CI."
    />
    <Card
        title="Conventional Commits"
        href="/docs/contributing/conventional-commits"
        description="Commit message structure, scopes, and optional interactive commit helpers."
    />
</Cards>
