...
```bash
# Ensure the repo-pinned pnpm version is active
...
### 2. Use the repo-local fumadocs-python CLI
...
2. Is the package available in the uv environment? (`uv sync --dev`)
...
<Cards>
  <Card href="/docs/development/python-api" title="View API Reference" description="Browse the generated API documentation" />
  <Card href="/docs/development/testing" title="Testing" description="Learn about our testing practices" />
  <Card href="/docs/development/contributing" title="Contributing" description="Contribute to AIWebFeeds" />
</Cards>
