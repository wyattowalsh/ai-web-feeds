...
<Callout type="info">This is a living security control. Any new inline script, third-party connect, or image source must be evaluated against the policy and either nonced (preferred) or explicitly added with justification.</Callout>
