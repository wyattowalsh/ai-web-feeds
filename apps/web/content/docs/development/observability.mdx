...
| `sessionCookiePresent` | boolean        | Whether a Better Auth session cookie was present (not role-validated). **SQL column:** `admin_session_present` (legacy name; no migration in this deliverable) |
