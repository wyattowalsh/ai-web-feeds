...
This site includes comprehensive AI integration following
[Fumadocs best practices](https://fumadocs.dev/docs/ui/llms):
...
1. Write content using MDX components
1. Run `pnpm dev` to see changes
