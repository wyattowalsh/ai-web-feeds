    ...
    <div className="page-wrap page-stack">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
          <div className="space-y-5">
            ...
            <div className="space-y-4">
              <h1 className="hero-title max-w-4xl">Track collection health instead of guessing at it.</h1>
      ...
      {!stats.validation_data_available && (
        <div className="surface-card flex gap-4 border-[color-mix(in_oklab,var(--danger-tone)_25%,var(--line))] bg-[color-mix(in_oklab,var(--danger-tone)_9%,var(--surface))]">
          ...
          <div>
            <p className="font-semibold text-(--ink)">Validation history is not currently available.</p>
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="surface-card flex items-start justify-between gap-4">
          <div className="space-y-3">
            ...
            <p className="metric-value">{renderMetric(stats.success_rate, (value) => `${value.toFixed(1)}%`)}</p>
            <p className="small-note">
            {stats.validation_data_available
        ...
        <div className="surface-card flex items-start justify-between gap-4">
          <div className="space-y-3">
            ...
            <p className="small-note">
            {stats.validation_data_available ? "HTTP fetch time" : "Validation snapshot unavailable"}
            </p>
          </div>
          <span className="flex size-12 items-center justify-center rounded-2xl bg-(--brand-soft) text-(--brand-strong)">
        ...
        <div className="surface-card flex items-start justify-between gap-4">
          <div className="space-y-3">
            ...
            <p className="metric-value">{renderMetric(stats.avg_health_score, (value) => value.toFixed(2))}</p>
            ...
            <div className="mt-5 space-y-4">
              <div>
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-sm font-semibold text-(--ink)">{stats.healthy_feeds} feeds</span>
                </div>
                <div className="h-2 w-full rounded-full bg-(--surface-muted)">
                  <div
                    className="bg-green-500 h-2 rounded-full"
