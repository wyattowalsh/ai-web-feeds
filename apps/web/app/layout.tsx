...
export const metadata: Metadata = {
  ...
  description: 'Curated RSS/Atom feeds optimized for AI agents and large language models. Access documentation in multiple formats with PDF export, LLM-friendly endpoints, and comprehensive feed support.',
  keywords: [
    'AI',
    'RSS feeds',
    'Atom feeds',
