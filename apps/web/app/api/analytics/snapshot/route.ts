  ...
  try {
    ...
    const snapshot = {
      ...
      trending_topics: [
        ...
        { topic: "training", feed_count: 165, validation_frequency: 68.7, avg_health_score: 0.9 },
      ],
      health_distribution: {
        healthy: 940,
        moderate: 240,
    ...
    return NextResponse.json({ error: "Failed to generate analytics snapshot" }, { status: 500 });
  }
}
