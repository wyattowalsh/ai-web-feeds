...
from ai_web_feeds.models import FeedEntry, Subtopic, TopicEvolutionEvent
            ...
            for parent_topic in topics_to_process:
                try:
                    ...
                    if len(articles) < min_articles:
                        logger.info(f"Skipping '{parent_topic}': insufficient articles ({len(articles)} < {min_articles})")
                        continue
