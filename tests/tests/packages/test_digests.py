...
class TestDigestManager:
    ...
    @pytest.mark.asyncio
    async def test_send_due_digests_success(self, digest_manager, mock_db, sample_digest, sample_articles):
    ...
    @pytest.mark.asyncio
    async def test_send_due_digests_failure(self, digest_manager, mock_db, sample_digest, sample_articles):
        """Test digest sending with SMTP error"""
        mock_db.get_due_digests.return_value = [sample_digest]
        mock_db.get_user_follows.return_value = ["feed-1"]
        mock_db.get_feed_entries.return_value = sample_articles  # Must have articles to trigger SMTP
    ...
    @pytest.mark.asyncio
    async def test_send_digest_with_articles(self, digest_manager, mock_db, sample_digest, sample_articles):
    ...
    @pytest.mark.asyncio
    async def test_send_digest_multiple_feeds(self, digest_manager, mock_db, sample_digest, sample_articles):
    ...
    @pytest.mark.asyncio
    async def test_send_digest_smtp_auth(self, digest_manager, mock_db, sample_digest, sample_articles):
    ...
    @pytest.mark.asyncio
    async def test_send_digest_article_ordering(self, digest_manager, mock_db, sample_digest, sample_articles):
