...
class TestTrendingTopics:
    ...
    def test_calculate_trending_topics_limit(
        self, test_session, sample_feeds, sample_validations
    ):
...
class TestHealthDistribution:
    ...
    def test_calculate_health_distribution(
        self, test_session, sample_feeds, sample_validations
    ):
...
class TestCSVReportGeneration:
    ...
    def test_generate_analytics_csv_report(
        self, test_session, sample_feeds, sample_validations
    ):
...
def test_summary_metrics_various_date_ranges(test_session, sample_feeds, sample_validations, date_range_days):
...
def test_velocity_various_granularities(test_session, sample_feeds, sample_validations, granularity):
