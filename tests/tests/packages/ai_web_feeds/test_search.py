...
from ai_web_feeds.models import FeedSource, FeedEmbedding, SearchQuery, SavedSearch
...
class TestSemanticSearch:
    ...
    def test_semantic_search_basic(self, mock_gen_embedding, test_session, sample_feeds, sample_embeddings):
    ...
    @patch('ai_web_feeds.search.generate_query_embedding')
    def test_semantic_search_with_threshold(self, mock_gen_embedding, test_session, sample_feeds, sample_embeddings):
...
@pytest.mark.parametrize("word,feed_id", [
    ("test", "feed1"),
    ("machine", "feed2"),
    ("learning", "feed3"),
    ("artificial", "feed4"),
...
@pytest.mark.parametrize("prefix,expected_min_results", [
